...
function myClass.Refresh(self, forceResort)
    ...
    elseif self.Sel=="bid" then
      ...
      if QDKP2_BidM_isBidding() then
        QDKP2_Frame2_Bid_Button:SetText("取消竞拍")
      else
        QDKP2_Frame2_Bid_Button:SetText("开始竞拍")
      end
...
func=function()
  QDKP2GUI_CloseMenus()
  QDKP2_OpenInputBox("输入用于快速编辑菜单的\n DKP 分值 .",
    function(amount)
...
AltMake={text="设置小号",func=function()
  if #myClass.SelectedPlayers == 2 then
    ...
    QDKP2_NotifyUser('按住 Ctrl 先选中小号再选中大号 ')
  end
end
},
ExternalAdd={text="添加会外人员",
func=function()
  QDKP2_NewExternal()
end
},
ExternalRem={text="移除会外人员",
func=function()
  if #myClass.SelectedPlayers>1 then return; end
  QDKP2_DelExternal(myClass.SelectedPlayers[1])
end
},
AddAsExternal={text="添加玩家为会外人员",
func=function()
  QDKP2_NewExternal(myClass.SelectedPlayers[1])
  myClass:Refresh()
end,
},
StandbyAdd={text="添加为活动替补",
...
AddPlayersToCustom={text="添加成员到自定义花名册",
func=function()
...
RemPlayerFromCustom={text="从自定义花名册移除",
func=function()
  RemoveDict=DictFromList(myClass.SelectedPlayers)
  for i,name in pairs(QDKP2GUI_Vars.CustomPlayerRosterList) do
    if RemoveDict[name] then table.remove(QDKP2GUI_Vars.CustomPlayerRosterList,i); end
  end
  myClass:ChangeList(myClass.Sel)
end,
},
CleanCustom={text="清空自定义花名册",
...
ExportSelected={text="为选中玩家导出 DKP",
func=function() QDKP2_Export_Popup('list','text',myClass.SelectedPlayers); end,
},
SetWinner={text="设为竞拍胜者",
func=function()
  QDKP2_BidM_Winner(myClass.SelectedPlayers[1])
end
},
CancelBid={text="取消此次出分",
func=function()
  for i,name in pairs(myClass.SelectedPlayers) do
...
SelectAll={text="全选", func=myClass.SelectAll},
SelectNone={text="全不选",func=myClass.SelectNone},
SelectInvert={text="反向选择",func=myClass.SelectInvert},
ExternalPost={text="Post External amounts", func=function() QDKP2_PostExternals("GUILD"); end},
RosterUpdate={text="更新花名册", func=myClass.Update},
